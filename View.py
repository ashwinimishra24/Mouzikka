...
class View:
    ...
    def setup_player(self):
        ...
        img = tk.PhotoImage(file="./icons/mainlogo.png")
    ...
    def remove_song(self):
        ...
        try:
            if len(self.sel_song_index_tuple) == 0:
                raise NoSongSelectedError("Plz select a song")
    ...
    def play_song(self):
        ...
        try:
            if len(self.sel_song_index_tuple) == 0:
                raise NoSongSelectedError("Plz select a song to play")
    ...
    def add_song_to_favourites(self):
        ...
        try:
            if len(fav_song_index_tuple)==0:
                raise NoSongSelectedError("plz select a song before adding to favourites")
    ...
    def load_songs_from_favourites(self):
        try:
            ...
            if result.find("No songs present in your favourites")!=-1:
            ...
            mycolor = "#" + red + green + blue
            self.playList.config(fg=mycolor)
            messagebox.showinfo("Favourites Loded", "songs loaded successfully")
        except(DatabaseError) as ex2:
            messagebox.showerror("DB Error", "Song can't be added")
            print(traceback.format_exc())
    ...
    def remove_song_from_favourites(self):
        ...
        try:
            ...
            if result.find("No songs present in your favourites") != 0:
                self.playList.delete(rem_song_index_tuple[0])
            if rem_song_index_tuple[0]==self.sel_song_index_tuple[0]:
                self.stop_song()
            messagebox.showinfo("Success", result)
        except(NoSongSelectedError) as ex1:
            messagebox.showerror("Error", ex1)
        except(DatabaseError) as ex2:
            messagebox.showerror("DB Error", "Song can't removed from favourites")
            print(traceback.format_exc())
